...
<div class="ld-focus-header">
	...
	if ( ! is_user_logged_in() && wp_is_mobile() ) {
		echo '<a href="/" class="text-sm ml-3 text-primary-color font-semibold flex items-center"><span class="flex w-4 h-4 rotate-90">' . get_svg( 'icons/carret-down', false ) . '</span>Back to home</a>'; // phpcs:ignore
	}
	?>
	<!-- End of added by Sajid Khan -->
